...
![Fig009 三分频概念结构](/img/wiener-filter-noise-reduction/Fig009_三分频概念结构.png)
...
![余弦调制如何搬移频谱](/img/wiener-filter-noise-reduction/Fig001_余弦调制如何搬移频谱.png)
...
![同一原型生成三个子带滤波器](/img/wiener-filter-noise-reduction/Fig002_同一原型生成三个子带滤波器.png)
...
![三个卷积如何重排为共享滤波与DCT](/img/wiener-filter-noise-reduction/Fig003_三个卷积如何重排为共享滤波与DCT.png)
...
![DCT矩阵如何读取三路模式](/img/wiener-filter-noise-reduction/Fig004_DCT矩阵如何读取三路模式.png)
...
![Fig010 分析与综合数据流](/img/wiener-filter-noise-reduction/Fig010_分析与综合数据流.png)
...
![Fig002 低分位噪声跟踪原理](/img/wiener-filter-noise-reduction/Fig002_低分位噪声跟踪原理.png)
...
![Fig004 在线分位数游标如何更新](/img/wiener-filter-noise-reduction/Fig004_在线分位数游标如何更新.png)
...
![Fig007 参数噪声模型决策流程](/img/wiener-filter-noise-reduction/Fig007_参数噪声模型决策流程.png)
...
![Fig005 白噪声与粉噪声的频谱特征](/img/wiener-filter-noise-reduction/Fig005_白噪声与粉噪声的频谱特征.png)
...
$$
\begin{aligned}
b &= \frac{S_{xx}S_y-S_xS_{xy}}{D} \\[4pt]
...
![Fig006 启动参数噪声模型处理流程](/img/wiener-filter-noise-reduction/Fig006_启动参数噪声模型处理流程.png)
...
![Fig008 启动期噪声谱的组成](/img/wiener-filter-noise-reduction/Fig008_启动期噪声谱的组成.png)
...
![Fig003 噪声估计器协同机制](/img/wiener-filter-noise-reduction/Fig003_噪声估计器协同机制.png)
...
![Fig011 语音概率估计流程](/img/wiener-filter-noise-reduction/Fig011_语音概率估计流程.png)
...
![Fig013 DD回路数据流](/img/wiener-filter-noise-reduction/Fig013_DD回路数据流.png)
...
![Fig014 增益公式拆解](/img/wiener-filter-noise-reduction/Fig014_增益公式拆解.png)
...
![Fig012 维纳增益特性与DD平滑](/img/wiener-filter-noise-reduction/Fig012_维纳增益特性与DD平滑.png)
...
![Fig015 DD跨帧机制全景](/img/wiener-filter-noise-reduction/Fig015_DD跨帧机制全景.png)
...
![Fig016 DD噪声段vs语音段](/img/wiener-filter-noise-reduction/Fig016_DD噪声段vs语音段.png)
