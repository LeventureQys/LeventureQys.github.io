...
![原始信号](/img/signal_denoise/00_raw_data.png)
...
$$
\begin{aligned}
\text{Predict:}\quad \hat{x}_k^- &= F \hat{x}_{k-1} \\
P_k^- &= F P_{k-1} F^T + Q \\[4pt]
...
![卡尔曼滤波](/img/signal_denoise/01_kalman.png)
...
![Holt-Winters](/img/signal_denoise/02_holtwinters.png)
...
![高斯 vs 巴特沃斯](/img/signal_denoise/03_gaussian_butter.png)
...
![Savitzky-Golay](/img/signal_denoise/04_savgol.png)
...
![基准线](/img/signal_denoise/05_baseline.png)
...
![频域分析](/img/signal_denoise/06_frequency.png)
...
![综合仪表盘](/img/signal_denoise/07_dashboard.png)
