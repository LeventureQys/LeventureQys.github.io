...
![图 FIG-10：GTCRN 设计目标分解](/img/gtcrn_complete/fig10_design_strategy.png)
...
![图 FIG-01：GTCRN 整体架构](/img/gtcrn_complete/fig01_overall_architecture.png)

下面补一张更细的数据流图，把各阶段的 shape 和 skip connection 也一起标出来：

![图 FIG-11：GTCRN 详细数据流](/img/gtcrn_complete/fig11_overall_flow_detail.png)
...
![图 FIG-02：ERB 频带压缩示意](/img/gtcrn_complete/fig02_erb_compression.png)
...
![图 FIG-12：ERB 三角滤波器示意](/img/gtcrn_complete/fig12_erb_triangles.png)
...
![图 FIG-03：GT-Conv 块完整结构](/img/gtcrn_complete/fig03_gtconv_block.png)
...
![图 FIG-04：三层 Dilated Conv 的感受野累积（1/2/5）](/img/gtcrn_complete/fig04_dilated_receptive_field.png)
...
![图 FIG-05：对称 padding vs 因果左侧 padding](/img/gtcrn_complete/fig05_causal_padding.png)
...
![图 FIG-06：DPGRNN 双路径——Intra（沿 F 双向）+ Inter（沿 T 单向）](/img/gtcrn_complete/fig06_dpgrnn_dual_path.png)
...
![图 FIG-13：标准 GRU 与 Grouped GRU 的权重结构对比](/img/gtcrn_complete/fig13_grouped_gru_matrix.png)
...
![图 FIG-07：SFE 把邻近 3 个频带的特征堆到通道维](/img/gtcrn_complete/fig07_sfe_operation.png)
...
![图 FIG-08：TRA 五步流程——能量聚合 → GRU → FC → Sigmoid → 广播相乘](/img/gtcrn_complete/fig08_tra_module.png)
...
![图 FIG-14：CRM 复数掩码作用过程](/img/gtcrn_complete/fig14_crm_process.png)
...
![图 FIG-15：混合损失组成示意](/img/gtcrn_complete/fig15_hybrid_loss.png)
...
![图 FIG-09：流式推理时的 cache FIFO 更新机制](/img/gtcrn_complete/fig09_stream_cache.png)
