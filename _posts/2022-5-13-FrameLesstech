...
categories: 经验之谈
description: 最近工作一个项目需要用QT设计一个UI，看了一下目前主流商业化UI，例如扣扣，微信，网易云音乐…结合个人审美（本人非美术专业，但游戏经验丰富，对人机交互界面有个人看法），目前界面风格都是扁平化，纯色调，简单易懂。下面是网易云音乐的效果，本人比较喜欢科技风，类似《使命召唤》和《钢铁侠》风格交互。
