...
之前在网上感觉怎么找都不太好看懂，这有个比较全的[如何在QT中使用正则表达式](https://blog.csdn.net/Hyc_cheng/article/details/112132963)

最后我总结了一下如何在Qt中使用正则匹配模式，详情请参考博客页面[ Qt有关正则表达式的写法与应用实例以及常见的正则匹配模式 ](https://leventureqys.github.io//2022/05/21/RegularRegex/)
